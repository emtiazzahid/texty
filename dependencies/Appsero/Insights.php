...
class Insights {
    ...
    public function admin_notice() {
        ...
        $notice .= 'We are using Texty\Dependencies\Appsero to collect your data. <a href="' . $policy_url . '" target="_blank">Learn more</a> about how Texty\Dependencies\Appsero collects and handle your data.</p>';
            ...
            <div class="wd-dr-modal-wrap">
                ...
                <div class="wd-dr-modal-body">
                    ...
                    <p class="wd-dr-modal-reasons-bottom">
                        <?php
                        echo sprintf(
                            $this->client->__trans( 'We share your data with <a href="%1$s" target="_blank">Appsero</a> to troubleshoot problems &amp; make product improvements. <a href="%2$s" target="_blank">Learn more</a> about how Texty\Dependencies\Appsero handles your data.' ),
